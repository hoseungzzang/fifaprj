...
<body>
	...
	<main class="" style="background-color: #f5f5f5; height: 1270px;">
		...
		<div
			...
			<div class="btn-toolbar mb-2 mb-md-0">
				<div class="btn-group me-2">
					<button type="button" id="fMatch" value="fMatch"
						class="btn btn-outline-secondary" onclick="fMatchToggle();"
						style="color: white; background-color: black;">친선전</button>
					<button type="button" id="lMatch" value="lMatch"
		...
		<input type="hidden" id="selectVsMatch" name="selectVsMatch" value="fMatch"></input>
		...
		<div class="btn-toolbar mb-2 mb-md-0 center">
			...
			<div class="btn-group me-2">
				<button class="btn btn-sm fontBlack" style="margin-bottom: 4px;"
					onclick="location.href='mainAllSearch'; return false;">전체
					전적검색</button>
			</div>
		</div>
